...
class CustomPolygon:
    ...
    def _efficiency(vertices, common_circum_radius):
        ...
        area = 0.5 * vertices * CustomPolygon._edgeLength(common_circum_radius, vertices) * CustomPolygon._apothem(
            common_circum_radius, vertices)
    ...
    def max_efficiency(self):
        ...
        print(
            f'Maximum efficiency polygon has Vertices : {efficiency.index(max_efficiency) + 3} and Circum Radius : {self.common_circum_radius} ')
